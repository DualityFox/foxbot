...
module.exports = {
    run: (message, args, client) => {
        if (args[0]) {
            ...
            .addField('🔗Lien utile (Actuellement indisponible) :','[Ajoute-moi] | [Donne ton avis sur le serveur](https://top.gg/servers/731599872892993626) | [Vote pour le serveur](https://top.gg/servers/731599872892993626)', false)
